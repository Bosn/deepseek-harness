...
const EXECUTABLE_SOURCE_ALLOWLIST = new Map<string, string>([
  ...
  ['apps/cli/tests/profiles/sdk/fixtures/turn-notify-wechat-sender.mjs', 'test-only notification sender'],
  ...
  ['packages/session/maintenance-reporter/tests/fixtures/driver.ts', 'test-only subprocess driver'],
