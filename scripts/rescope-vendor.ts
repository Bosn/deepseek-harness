...
/** Generated descriptor/codec contribution with no shared runtime identity. */`,
  ...
  {
    // The step-1 file tree must describe the package name in the running scope
    // while preserving the release-member policy in either codemod direction.
  ...
  {
    // The release version follows the harness in both directions; only the
    // upstream package name changes when the rescope is reversed.
