...
/** Browser location fields used to classify loopback authority and declared authorities. */
export interface ConnectionLocation {
  readonly hostname: string
  /** Explicit URL port, or the empty string when the URL omits it; omitted counts as absent. */
