...
function mount(overrides: Partial<WorkspaceBrowserProps> = {}) {
  ...
  const props: WorkspaceBrowserProps = {
    ...
    useHostInfo: selector => selector({ home: undefined, isLoopback: true, canUseHostConfiguration: true }),
  ...
  it('workspace hover card shows a POSIX home descendant as ~', () => {
    ...
    try {
      mount({
        ...
        useHostInfo: selector => selector({ home: '/home/u', isLoopback: true, canUseHostConfiguration: true }),
      })
