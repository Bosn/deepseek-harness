...
// Every form uses the persistence mode resolved from the connected Host's
  // declared configuration capability.
  const persistence = ctx.remote.$host.canUseHostConfiguration ? 'host' : 'memory'
