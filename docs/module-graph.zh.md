...
flowchart TD
  ...
  subgraph group_session["packages/session"]
    pkg_maintenance_reporter["maintenance-reporter"]
    ...
    pkg_turn_notify_wechat["turn-notify-wechat"]
  end
  ...
  pkg_turn_notify_wechat --> pkg_invariants
  pkg_turn_notify_wechat --> pkg_session
  pkg_turn_notify_wechat --> pkg_session_title
  ...
  pkg_maintenance_reporter --> pkg_agent
  pkg_maintenance_reporter --> pkg_invariants
  pkg_maintenance_reporter --> pkg_session
  pkg_maintenance_reporter --> pkg_shell
  pkg_maintenance_reporter --> pkg_shell_env
  ...
  pkg_client_ui_chat --> pkg_client_connection
...
| [`turn-notify-wechat`](../packages/session/turn-notify-wechat) | `session` | [`invariants`](../packages/runtime-diagnostics/invariants), [`session`](../packages/core/session), [`session-title`](../packages/session/session-title) |
...
| [`maintenance-reporter`](../packages/session/maintenance-reporter) | `session` | [`agent`](../packages/core/agent), [`invariants`](../packages/runtime-diagnostics/invariants), [`session`](../packages/core/session), [`shell`](../packages/shell/shell), [`shell-env`](../packages/shell/shell-env) |
