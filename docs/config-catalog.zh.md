...
来源： [`packages/client/connection/src/index.ts:94`](../packages/client/connection/src/index.ts)
...
来源： [`packages/compaction/compaction-basic/src/types.ts:62`](../packages/compaction/compaction-basic/src/types.ts)
