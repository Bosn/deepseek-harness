...
- [RATE_LIMIT cooldown retry](../../implemented/bug-fix/2026-08-21-rate-limit-cooldown-retry.md) owns the one/three/five-minute cooldown schedule and the quota-worded-429 classification.
