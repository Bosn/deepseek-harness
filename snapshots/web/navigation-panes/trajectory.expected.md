...
- table:
  - rowgroup:
    ...
    - 'row "TOOL, read {\"file_path\": \"nav-a.md\"}"':
      - cell "TOOL"
      - 'cell "read{\"file_path\": \"nav-a.md\"} → <path>{{cwd}}/workspace/nav-a.md</path> <type>file</type> <content> 1: # alpha nav (End of file - total 1 lines) </content>"'
    - 'row "TOOL, read {\"file_path\": \"nav-b.md\"}"':
      - cell "TOOL"
      - 'cell "read{\"file_path\": \"nav-b.md\"} → <path>{{cwd}}/workspace/nav-b.md</path> <type>file</type> <content> 1: # beta nav (End of file - total 1 lines) </content>"'
